...
func Upgrader(w http.ResponseWriter, req *http.Request) (*Ws, error) {
	...
	return &Ws{conn, bufrw, req.Header, 1000, req.Context()}, nil
}
...
func Handler(onReceiveBinary func(*Ws, Frame), beforeReceive func(*Ws)) func(http.ResponseWriter, *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		for {
			...
			case 9: // Ping
				frame.Opcode = 10
				fallthrough
			case 0, 1: // Continuation or Text
				fallthrough
			case 2: // Binary
				onReceiveBinary(ws, frame)
			}
		}
	}
}
...
type WSHandlerOptions struct {
	OnContinuation func(*Ws, Frame)
}
type WSHandler struct {
	onContinuation func(*Ws, Frame)
}

func NewWSHandler(options ...func(*WSHandlerOptions)) *WSHandler {
	handler := &WSHandler{}
